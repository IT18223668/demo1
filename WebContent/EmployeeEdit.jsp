...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Employee Management</div>
						</div>
					</div>
				</div>
			</div>
	...
	<%
		...
		PreparedStatement ps=DBconnect.getCon().prepareStatement("select * from employee where empid='"+num+"'");
	...
	<br>
					...
					Employee ID<input type="text" name="empID" value=<%=num %> disabled="disabled">
					Employee Name<input type="text" name="empName" value=<%=result.getString(2) %>>
					Employee Address<input type="text" name="empAddress" value=<%=result.getString(6) %>>
					Employee ContactNo<input type="text" name="empContact" value=<%=result.getString(4) %>>
					Employee NIC<input type="text" name="empNIC" value=<%=result.getString(5) %>>
					Designation<input type="text" name="designation" value=<%=result.getString(3) %>>
	...
	<a href="EmployeeManagement.jsp">Back to Home</a>
...
<%
	...
	String c=request.getParameter("empAddress");
	String d=request.getParameter("empContact");
	String e=request.getParameter("empNIC");
	...
	empl2.setEmployeeID(num);
	empl2.setName(b);
	empl2.setAddress(c);
	empl2.setMobileNo(d);
	empl2.setNic(e);
	empl2.setDesignation(f);
	
	EMPService.updateEmployee(empl2);
