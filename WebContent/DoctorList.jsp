...
<div class="super_container">
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Doctors List</div>
						</div>
					</div>
				</div>
			</div>
	...
	<%
		...
		hs1.setAttribute("all Doctors", docS.getAlldocs());
...
<table>
	<tr>
		<td width=100px>DoctorID</td>
		<td width=100px>Doctor Name</td>	
		<td width=100px>DoctorAge</td>
		<td width=100px>Specialization</td>
		<td width=100px>Contact No</td>
		<td width=100px>Email</td>
		<td width=100px>Password</td>
		<td width=100px>Day Attempts</td>
		
		
		
	</tr>
	<%
		ArrayList<doctor> doc1=(ArrayList<doctor>) session.getAttribute("all Doctors");
		for(doctor d:doc1){
	%>
	
	<tr>
		<td
			 onclick="location.href='DoctorList.jsp?id=<%=d.getDocId()%>'">
		<%
			out.print(d.getDocId());
		%>
		</td>
		<td
			onclick="location.href='DoctorList.jsp?id=<%=d.getDocId()%>'">
		...
		<td
			onclick="location.href='DoctorList.jsp?id=<%=d.getDocId()%>'">
			<%
				out.print(d.getDaysattempt());
			%>	
		</td>
			<td>
			<form action="delete" method="post">
		<input type="hidden" value=<%=d.getDocId() %> name="docID" >
		<input type="submit" value="delete">
		</form>
			</td>
			<td>
				<a href="DoctorEdit.jsp?u=<%=d.getDocId()%>">Edit</a>
			</td>
	</tr>
