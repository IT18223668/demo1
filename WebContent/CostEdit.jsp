...
<html lang="en">
<head>
<title>Edit Costs' Details</title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<%
		...
		PreparedStatement ps=DBconnect.getCon().prepareStatement("select * from cost where costid='"+num+"'");
	...
	<br>
					<form action="" method="post">
					 ID<input type="text" name="supID" value=<%=num %> disabled="disabled">
					Description<input type="text" name="desc" value=<%=result.getString("description") %>>
					Cost<input type="text" name="cost" value=<%=result.getString("cost") %>>
					Date<input type="date" name="date" value=<%=result.getString("date") %>>
	...
	<a href="costs.jsp">Back to Home</a>
...
<%
	try{
		...
		costservice cost1=new costserviceImpl();
		
		
		cst.setCostid(num);
		cst.setDescription(b);
		cst.setCost(Integer.parseInt(c));
		cst.setDate(d);
		
		if(cost1.updatecost(cst)){
