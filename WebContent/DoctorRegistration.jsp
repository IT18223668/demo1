				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Doctor Registration</div>
						</div>
					</div>
				</div>
			</div>
...
<!-- OPD Registration -->
	...
	<br><form action=Add method="post">
		<tr><td>Doctor Name</td><td><input type="text" name="dcname"></td></tr><br>
		<tr><td>Age</td><td><input type="text" name="Dage" required></td></tr><br>
		<tr><td>Specialization</td><td><input type="text" name="specialization"required></td></tr><br>
		<tr><td>Contact No</td><td><input type="text" name="dcontactno"required></td></tr><br>
		<tr><td>password</td><td><input type="text" name="dpassword"required></td></tr><br>
		<tr><td>email</td><td><input type="text" name="dmail"required></td></tr><br>
		<tr><td>Day Attempts</td><td><input type="text" name="days"required></td></tr><br>
