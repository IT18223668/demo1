<%@page import="groovyjarjarasm.asm.tree.TryCatchBlockNode"%>
...
<div class="super_container">
	...
	<%
		...
		PreparedStatement ps=DBconnect.getCon().prepareStatement("select * from patients where pid='"+num+"'");
	...
	<form action="" method="post">
		...
		PatientID<input name="ptid" value=<%=num  %> disabled="disabled" ><br>
		Name<input type="text" name="pname" value=<%=result.getString("name") %> ><br>
		Age<input type="text" name="age" value=<%=result.getString("age") %> ><br>
		Weight<input type="text" name="weight" value=<%=result.getString("weight") %> ><br>
		Height<input type="text" name="height" value=<%=result.getString("height") %> ><br>
		Address<input type="text" name="address" value=<%=result.getString("address") %> ><br>
		Diagnose<input type="text" name="diagnose" value=<%=result.getString("diagnose") %> ><br>
		Drugs<input type="text" name="drugs" value=<%=result.getString("drugs") %> ><br>
		<input type="submit" value="Edit" >	
	


		</form>
	<a href="OPDm.jsp">Back to Home</a>
...
<%
			...
			String e=request.getParameter("height");
			String f=request.getParameter("address");
			String g=request.getParameter("diagnose");
			String h=request.getParameter("drugs");
