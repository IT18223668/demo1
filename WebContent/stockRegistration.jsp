...
<!-- OPD Registration -->
	...
	<br>
					...
					Supplier ID<input type="text" name="suplID">
					Supplier Name<input type="text" name="suplName">
					Price<input type="text" name="price">
					Quantity<input type="text" name="quantity">
					Order Level<input type="text" name="level">
					Per Tablet<input type="text" name="perTablet">
					Per Card<input type="text" name="perCard">
