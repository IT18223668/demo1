				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Supplier-Registration</div>
						</div>
					</div>
				</div>
			</div>
...
<!-- OPD Registration -->
	...
	<br><form action=Add method="post">
		Supplier Name<input type="text" name="spname"><br>
		Address<input type="text" name="address" required><br>
		Contact Number<input type="text" name="mobno"required><br>
		Email<input type="text" name="mail"required><br>
		Join Date<input type="date" name="joindate"required><br>
		Item Category<input type="text" name="itemCategory"required><br>
