...
<!-- OPD Homepage -->
	...
	<%
		...
		hs.setAttribute("ALLemployees", emp.getAllEmployee());
	%>
	
	

	<br><a href="EmployeeRegistration.jsp">+ Add new Employee</a>
 	<br><a href="EmployeeSalary.jsp"> Employee Salary Management</a>
...
<h2>Employee</h2>
	...
	<tr>
		...
		<td width=100px>NIC no</td>
		<td width=100px>Mobile No</td>
		<td width=100px>Address</td>
	</tr>
	<%
		ArrayList<Employee> employee=(ArrayList<Employee>) session.getAttribute("ALLemployees");
		for(Employee e:employee){
	%>
	
	<tr>
		<td
			 onclick="location.href='EmployeeManagement.jsp?id=<%=e.getEmployeeID()%>'">
		<%
		...
		<td
			...
			<td> 
				<a href="EmployeeEdit.jsp?u=<%=e.getEmployeeID()%>">Edit</a>
			</td>
		    <td>
