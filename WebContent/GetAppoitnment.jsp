				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Channeling Doctor</div>
						</div>
					</div>
				</div>
			</div>
...
<%
		...
		PreparedStatement ps=DBconnect.getCon().prepareStatement("select * from doctor doctor where docID='"+num+"'");
	...
	<br>
	Doctor Name<input type="text" disabled="disabled"  value=<%=result.getString(2) %>><br>
	<form action=Add method="post">
		<input type="hidden" name="DOCID" value=<%=num %>><br>
		
		
		Patient Name<input type="text" name="APTname"><br>
		Age<input type="text" name="APTage" required><br>
		Gender<input type="text" name="APTgender"required><br>
		Contact No<input type="text" name="APTcontactno"required><br>
		Email<input type="text" name="APTmail"required><br>
		Address<input type="text" name="APTaddress"required><br>
